...
$oldumask = umask(0);
mkdir("../" . $category, 0777); // or even 01777 so you get the sticky bit set
$my_file = "../" . $category . "/index.php";
$handle = fopen($my_file, 'w') or die('Cannot open file:  '.$my_file); //implicitly creates file
umask($oldumask); 
$my_file = "../" . $category . "/index.php";
$handle = fopen($my_file, 'w') or die('Cannot open file:  '.$my_file);
$data = file_get_contents('templates/categoryinfo.php');
fwrite($handle, $data);
$stmt->close();
$con->close();
}
...
<html lang="en">
    <head>
        ...
        <title>NeikoPanel | Add Category</title>
