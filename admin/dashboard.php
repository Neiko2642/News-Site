...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>NeikoPanel | Dashboard</title>
...
?>
                                        ...
                                        <h2><?php echo $Is_Active;?> <small></small></h2>
...
<a href="manage-subcategories.php">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    ...
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">Listed Writters</p>
<?php
$stmt = $con -> prepare('select COUNT(*) from  tblwritter where Is_Active=?');
...
<?php 
$stmt = $con -> prepare('select COUNT(*) from tblposts where Is_Active=?');
